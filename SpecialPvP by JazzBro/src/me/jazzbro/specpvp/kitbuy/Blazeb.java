...
public class Blazeb implements CommandExecutor{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String labek, String[] args) {
		...
		if (Main.econ.withdrawPlayer(player, 500).transactionSuccess()) {
			Bukkit.getServer().dispatchCommand(Bukkit.getConsoleSender(), "pex user " + player.getName() + " add sp.blaze");
			player.sendMessage(Main.PREFIX + ChatColor.GREEN + "You have bought Blaze kit!");
		} 
		else { 
